...
export const DOMAIN_COPY = {
  uncertainty: {
    label: "불확실성",
    caught: "판단이 불확실성에서 붙잡혔다면, 아직 확인하지 못한 것이 판단을 계속 열어두게 한 것입니다.",
    release: "필요한 것이 충분히 확인되었을 때 다시 움직일 수 있다는 의미입니다.",
  },
  loss: {
    label: "손실",
    caught: "판단이 손실에서 붙잡혔다면, 선택의 이익보다 잘못되었을 때 감당하게 될 결과가 먼저 중요해진 것입니다.",
    release: "좋지 않은 결과가 생겨도 감당할 수 있다고 느끼는 것이 다시 움직일 수 있는 조건입니다.",
  },
  responsibility: {
    label: "책임",
    caught: "판단이 책임에서 붙잡혔다면, 결정 이후 내가 맡게 될 몫이 판단의 중요한 조건으로 들어온 것입니다.",
    release: "그 결과를 맡을 준비가 되었다고 느끼는 것이 다시 움직일 수 있는 조건입니다.",
  },
  self_permission: {
    label: "자기허용",
    caught: "판단이 자기허용에서 붙잡혔다면, 선택의 가능성보다 먼저 '내가 정말 이것을 선택해도 되는가'가 판단에 들어온 것입니다.",
    release: "내가 이 선택을 해도 괜찮다고 느끼는 것이 다시 움직일 수 있는 조건입니다.",
  },
  relationship: {
    label: "관계",
    caught: "판단이 관계에서 붙잡혔다면, 선택 자체와 함께 그 선택이 사람 사이에 만들 변화가 중요하게 고려된 것입니다.",
    release: "관계가 달라질 가능성까지 받아들일 수 있을 때 다시 움직일 수 있다는 의미입니다.",
  },
  evaluation: {
    label: "평가",
    caught: "판단이 평가에서 붙잡혔다면, 선택의 결과와 함께 그 선택이 나에 대한 인식에 어떤 영향을 줄지가 중요하게 들어온 것입니다.",
...
function buildNarrative({ defaultStrategy, judgmentProcess, pressure }) {
  ...
  if (triggerCopy && releaseCopy) {
    if (trigger.domain === release.domain) {
      ...
      paragraphs.push(
        `이번 경우, 판단을 붙잡는 지점(${triggerCopy.label})과 판단을 다시 움직이게 하는 지점(${releaseCopy.label})이 서로 다르게 나타났습니다.`
      );
    }
  }
