...
const EXPERIENCES = [
  ...
  { key: "meditatio", number: "02", title: "판단이 만들어지는 과정", q: "나는 무엇을 보고 판단을 내릴까?", doneKey: "meditatio" },
  { key: "judgment", number: "03", title: "다른 역할 입어보기", q: "다른 판단 방식을 써보면 무엇이 달라질까?", doneKey: null },
];
