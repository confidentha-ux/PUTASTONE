...
.st-root { --ground:#16131c; --paper:#ece7de; --ink:#221d2b; --muted:#7d7489; --open:#d6a756; --line:rgba(236,231,222,.14);
...
.st-textarea { width:100%; min-height:80px; background:rgba(236,231,222,.04); border:1px solid var(--line);
...
.st-textarea::placeholder { color:rgba(236,231,222,.28); }
.st-opts { display:flex; flex-direction:column; gap:8px; margin-bottom:16px; }
.st-opt { text-align:left; padding:13px 15px; border-radius:2px; cursor:pointer; background:rgba(236,231,222,.035);
  border:1px solid var(--line); color:var(--paper); font-size:14px; font-family:inherit; }
.st-opt:hover { background:rgba(236,231,222,.07); }
.st-opt.sel { background:rgba(214,167,86,.13); border-color:var(--open); color:#f6ecda; }
.st-next { width:100%; padding:14px; border-radius:2px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14.5px; cursor:pointer; font-family:inherit; }
.st-next:disabled { background:rgba(236,231,222,.07); color:var(--muted); cursor:default; }
...
.st-item-input { flex:1; background:rgba(236,231,222,.04); border:1px solid var(--line); border-radius:2px; color:var(--paper);
  font-family:inherit; font-size:14px; padding:12px 13px; box-sizing:border-box; }
.st-item-input::placeholder { color:rgba(236,231,222,.28); }
.st-item-add { padding:0 18px; border-radius:2px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14px; cursor:pointer; font-family:inherit; }
.st-item-list { display:flex; flex-direction:column; gap:6px; margin-bottom:16px; }
.st-item-row { display:flex; align-items:center; justify-content:space-between; background:rgba(236,231,222,.04); border:1px solid var(--line);
...
.st-summary-card { background:linear-gradient(160deg,#f2eee6,#e4ded3); color:var(--ink); border-radius:3px; padding:18px 20px;
...
.st-summary-label { font-size:10.5px; color:#8a8070; letter-spacing:.04em; margin-bottom:3px; }
.st-summary-value { font-family:'Gowun Batang',serif; font-size:14.5px; line-height:1.6; }
...
.st-result-card { background:linear-gradient(160deg,#f2eee6,#e4ded3); color:var(--ink); border-radius:3px; padding:16px 18px;
...
.st-final-text { font-size:14px; line-height:1.85; color:#e8e2d6; }
...
.st-complete { width:100%; padding:14px; margin-top:24px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14.5px; cursor:pointer; border-radius:2px; font-family:inherit; }
`;
      ...
      <div className="st-shell">
        ...
        {step === "s7" && (
          <>
            ...
            {error && <p className="st-hint" style={{ color: "#e08a8a" }}>{error}</p>}
            <div className="st-actions-row">
