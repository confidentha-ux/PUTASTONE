...
.pn-root { --ground:#16131c; --paper:#ece7de; --ink:#221d2b; --muted:#7d7489; --open:#d6a756; --line:rgba(236,231,222,.14);
...
.pn-textarea { width:100%; min-height:80px; background:rgba(236,231,222,.04); border:1px solid var(--line);
...
.pn-textarea::placeholder { color:rgba(236,231,222,.28); }
.pn-opts { display:flex; flex-direction:column; gap:8px; margin-bottom:16px; }
.pn-opt { text-align:left; padding:13px 15px; border-radius:2px; cursor:pointer; background:rgba(236,231,222,.035);
  border:1px solid var(--line); color:var(--paper); font-size:14px; font-family:inherit; }
.pn-opt:hover { background:rgba(236,231,222,.07); }
.pn-opt.sel { background:rgba(214,167,86,.13); border-color:var(--open); color:#f6ecda; }
.pn-next { width:100%; padding:14px; border-radius:2px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14.5px; cursor:pointer; font-family:inherit; }
.pn-next:disabled { background:rgba(236,231,222,.07); color:var(--muted); cursor:default; }
...
.pn-condition-card { background:linear-gradient(160deg,#f2eee6,#e4ded3); color:var(--ink); border-radius:3px; padding:20px;
  font-family:'Gowun Batang',serif; font-size:15.5px; line-height:1.75; margin-bottom:20px; box-shadow:0 10px 26px rgba(0,0,0,.3); }
.pn-condition-label { font-size:11px; color:#8a8070; font-family:Pretendard,sans-serif; margin-bottom:8px; letter-spacing:.04em; }
...
.pn-result-card { background:linear-gradient(160deg,#f2eee6,#e4ded3); color:var(--ink); border-radius:3px; padding:16px 18px;
...
.pn-final-text { font-size:14px; line-height:1.85; color:#e8e2d6; }
...
.pn-complete { width:100%; padding:14px; margin-top:24px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14.5px; cursor:pointer; border-radius:2px; font-family:inherit; }
`;
      ...
      <div className="pn-shell">
        ...
        {step === "s3" && (
          <>
            ...
            {error && <p className="pn-hint" style={{ color: "#e08a8a" }}>{error}</p>}
            <div className="pn-actions-row">
