...
.gd-root { --ground:#16131c; --paper:#ece7de; --ink:#221d2b; --muted:#7d7489; --open:#d6a756; --line:rgba(236,231,222,.14);
...
.gd-textarea { width:100%; min-height:80px; background:rgba(236,231,222,.04); border:1px solid var(--line);
...
.gd-textarea::placeholder { color:rgba(236,231,222,.28); }
.gd-opts { display:flex; flex-direction:column; gap:8px; margin-bottom:16px; }
.gd-opt { text-align:left; padding:13px 15px; border-radius:2px; cursor:pointer; background:rgba(236,231,222,.035);
  border:1px solid var(--line); color:var(--paper); font-size:14px; font-family:inherit; }
.gd-opt:hover { background:rgba(236,231,222,.07); }
.gd-opt.sel { background:rgba(214,167,86,.13); border-color:var(--open); color:#f6ecda; }
.gd-next { width:100%; padding:14px; border-radius:2px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14.5px; cursor:pointer; font-family:inherit; }
.gd-next:disabled { background:rgba(236,231,222,.07); color:var(--muted); cursor:default; }
...
.gd-summary-card { background:linear-gradient(160deg,#f2eee6,#e4ded3); color:var(--ink); border-radius:3px; padding:18px 20px;
...
.gd-summary-label { font-size:10.5px; color:#8a8070; letter-spacing:.04em; margin-bottom:3px; }
.gd-summary-value { font-family:'Gowun Batang',serif; font-size:14.5px; line-height:1.6; }
...
.gd-result-card { background:linear-gradient(160deg,#f2eee6,#e4ded3); color:var(--ink); border-radius:3px; padding:16px 18px;
...
.gd-final-text { font-size:14px; line-height:1.85; color:#e8e2d6; }
...
.gd-complete { width:100%; padding:14px; margin-top:24px; background:var(--open); border:none; color:#1b1509; font-weight:600; font-size:14.5px; cursor:pointer; border-radius:2px; font-family:inherit; }
`;
      ...
      <div className="gd-shell">
        ...
        {step === "s5" && (
          <>
            ...
            {error && <p className="gd-hint" style={{ color: "#e08a8a" }}>{error}</p>}
            <div className="gd-actions-row">
