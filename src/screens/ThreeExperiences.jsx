...
const EXPERIENCES = [
  { name: "선택", q: "나는 나를 위해 무엇을 선택할 수 있을까?", desc: "일상의 선택을 통해 내가 자연스럽게 선택하는 것과 조건이 필요한 것을 확인합니다." },
  { name: "판단", q: "나는 어떻게 하나의 결정을 내릴까?", desc: "무엇을 먼저 고려하고, 무엇을 근거로 삼고, 언제 결론을 내리는지 확인합니다." },
  { name: "다른 역할", q: "이 고민에서 내가 놓치고 있는 것은 무엇일까?", desc: "하나의 실제 고민에 서로 다른 질문을 적용합니다." },
];
