...
우리의 판단에도
지금까지 겪은 일과 그때마다 내린 선택이 하나씩 남아 있습니다.
...
그런 경험들은
무엇을 중요하게 보고, 무엇을 조심하며, 어떤 선택을 하는지에 영향을 줍니다.

누군가 쌓은 돌탑을 보면, 우리는 그것을 그냥 돌무더기로 보지 않습니다.
그 안에 담긴 건 각자의 소망이고, 그 소망을 비는 마음입니다.

여기서 쌓는 돌탑도 그렇습니다.
그 소망의 기준은 나 자신입니다.

여기서는 먼저
내가 나 자신을 어떻게 대하는지 알아보려 합니다.

그리고 실제 고민 하나를 가지고
평소에는 떠올리지 않았던 방식으로도 생각해봅니다.

돌 하나가 새롭게 더해지면
지금까지의 돌탑은 다른 탑이 될지도 모릅니다.`}
        </p>
      </div>
      <button
        onClick={onStart}
