...
.ws-root { --ground:#eae6da; --paper:#1c1a17; --ink:#1c1a17; --muted:#847c6b; --open:#a13d2e; --line:rgba(49,53,45,.14);
...
.ws-persona h1 { font-family:Pretendard,sans-serif;  font-size:32px; margin:0; font-weight:500; }
.ws-persona .en { font-size:12px; color:var(--muted); margin-top:4px; }
.ws-tagline { font-family:Pretendard,sans-serif; font-size:16px; line-height:1.6; color:var(--paper); text-align:center; margin:0 0 24px; }
.ws-persona-header { font-family:Pretendard,sans-serif; font-size:15px; line-height:1.6; color:#1c1a17; text-align:center; margin:0 0 20px; font-weight:600; }
.ws-subject { font-size:12px; color:var(--open); border-left:2px solid rgba(28,26,23,.5); padding-left:10px; margin-bottom:20px; line-height:1.6; }
.ws-step-label { font-size:11px; color:var(--muted); letter-spacing:.08em; margin-bottom:8px; }
.ws-q { font-family:Pretendard,sans-serif; font-size:18px; line-height:1.65; margin:0 0 6px; font-weight:400; }
.ws-hint { font-size:12.5px; color:var(--muted); margin:0 0 16px; line-height:1.6; }
.ws-textarea { width:100%; min-height:80px; background:rgba(49,53,45,.04); border:1px solid var(--line);
...
.ws-textarea::placeholder { color:rgba(49,53,45,.28); }
.ws-opts { display:flex; flex-direction:column; gap:8px; margin-bottom:16px; }
.ws-opt { text-align:left; padding:13px 15px; border-radius:2px; cursor:pointer; background:rgba(49,53,45,.035);
  border:1px solid var(--line); color:var(--paper); font-size:14px; font-family:inherit; }
.ws-opt:hover { background:rgba(49,53,45,.07); }
.ws-opt.sel { background:rgba(28,26,23,.13); border-color:var(--open); color:#1c1a17; }
.ws-next { width:100%; padding:14px; border-radius:2px; background:var(--open); border:none; color:#eae6da; font-weight:600; font-size:14.5px; cursor:pointer; font-family:inherit; }
.ws-next:disabled { background:rgba(49,53,45,.07); color:var(--muted); cursor:default; }
...
.ws-summary-card { background:linear-gradient(160deg,#f7f5ee,#ddd8ca); color:var(--ink); border-radius:3px; padding:18px 20px;
...
.ws-summary-label { font-size:10.5px; color:#6b6a5c; letter-spacing:.04em; margin-bottom:3px; }
.ws-summary-value { font-family:Pretendard,sans-serif; font-size:14.5px; line-height:1.6; }
...
.ws-result-card { background:linear-gradient(160deg,#f7f5ee,#ddd8ca); color:var(--ink); border-radius:3px; padding:16px 18px;
...
.ws-final-text { font-size:14px; line-height:1.85; color:#1c1a17; }
...
.ws-complete { width:100%; padding:14px; margin-top:24px; background:var(--open); border:none; color:#eae6da; font-weight:600; font-size:14.5px; cursor:pointer; border-radius:2px; font-family:inherit; }
`;
  ...
  return (
    <div className="ws-root">
      ...
      <div className="ws-shell">
        <div className="ws-eyebrow">돌 하나를 얹다</div>
        ...
        {step === "intro" && (
          <>
            ...
            <p className="ws-persona-header">말하지 않은 채 두었을 때 무엇이 남는지 봅시다.</p>
        ...
        {step === "s4" && (
          <>
            ...
            {error && <p className="ws-hint" style={{ color: "#c85f5f" }}>{error}</p>}
            <div className="ws-actions-row">
